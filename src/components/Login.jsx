...
export default function Login() {
  ...
  async function SignUp(e) {
    ...
    try {
      ...
      if (authData.user) {
        ...
        setModalMessage(
          "Подтвердите свою электронную почту, перейдя по ссылке во входящем письме. Проверьте папку 'Спам', если не видите письмо."
        );
        setShowModal(true);
        clearForm();
      }
  ...
  return (
    <>
        ...
        <div className="login-wrapper">
          <div className="login-panel">
            ...
            <form onSubmit={SignIn} className="login-form">
              ...
              <button
                type="button"
                className="login-hint policy-link"
                onClick={openPolicy}
              >
                Регистрируясь вы соглашайтесь с политикой конфиденциальности.
              </button>
            </form>
          </div>
        </div>
        ...
        >
          ...
          >
            <div className="modal-header">
              <h3 className="modal-title">Регистрация успешна! 🎉</h3>
      ...
      {showPolicy && (
        <div
          className={`modal-overlay ${policyClosing ? "closing" : ""}`}
          onClick={closePolicy}
        >
          <div
            className={`modal-content policy-modal ${
              policyClosing ? "closing" : ""
            }`}
            onClick={(e) => e.stopPropagation()}
          >
            <div className="modal-header">
              ...
              <button className="modal-close-btn" onClick={closePolicy}>
                &times;
              </button>
            </div>
            <div className="modal-body policy-body">
              <div className="policy-content">
                ...
                <p>
                  ...
                  предпринимаемые Андруник Арсений Андреевич (далее — Оператор).
                </p>
                <p>
                ...
                <p>
                  ...
                  веб-сайта{" "}
                  <a
                    href="https://to-do-list-andrunik.vercel.app/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="policy-link-inline"
                  >
                    https://to-do-list-andrunik.vercel.app/
                  </a>
                  .
                </p>
                ...
                <ul>
                  ...
                  <li>
                    ...
                    на направление требования о прекращении обработки
                    персональных данных;
                  </li>
                  <li>
                ...
                <div className="policy-table">
                  <div className="policy-table-row">
                    <div className="policy-table-cell policy-table-header">
                      Цель обработки
                    </div>
                    <div className="policy-table-cell">
                  ...
                  <div className="policy-table-row">
                    ...
                    <div className="policy-table-cell">электронный адрес</div>
                  </div>
                  <div className="policy-table-row">
                    <div className="policy-table-cell policy-table-header">
                      Правовые основания
                ...
                <p>
                  ...
                  Оператора{" "}
                  <a
                    href="mailto:andrunik2010@mail.ru"
                    className="policy-link-inline"
                  >
                    andrunik2010@mail.ru
                  </a>{" "}
            ...
            <div className="modal-footer">
              <button className="modal-ok-btn" onClick={closePolicy}>
                Закрыть
              </button>
            </div>
          </div>
